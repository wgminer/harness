...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            global_recording::recording_retry_global_transcription,
            global_recording::recording_cancel_global_transcription,
            global_recording::recording_cancel_global_session,
            global_recording::recording_stop_global_recording,
